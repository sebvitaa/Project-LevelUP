...
class LoginRequest extends FormRequest
{
    ...
    /**
     * Intenta autenticar al usuario, limitando los intentos por correo e IP.
     *
    ...
    public function authenticate(): void
    {
        ...
        if (! Auth::attempt($this->only('email', 'password'), $this->boolean('remember'))) {
            ...
            throw ValidationException::withMessages([
                'email' => 'Ese correo y contraseña no coinciden con ninguna cuenta.',
            ]);
        }
    ...
    private function ensureIsNotRateLimited(): void
    {
        if (RateLimiter::tooManyAttempts($this->throttleKey(), maxAttempts: 5)) {
            ...
            throw ValidationException::withMessages([
                'email' => "Demasiados intentos. Vuelve a probar en {$seconds} segundos.",
            ]);
        }
    }
